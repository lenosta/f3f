!function(t) {
        ...
        0 : function(t, e, i) {
            ...
            const l = t = >"number" == typeof t ? "#" + ("00000" + t.toString(16)).slice( - 6) : t,
                c = (t, e = 1) = >{
                const i = l(t),
        ...
        1 : function(t, e, i) {
            ...
            o.VantaBase = class {
                constructor(t = {}) {
                    var e, i, r, h;
                    if (o.current = this, this.onMouseMoveWrapper = this.onMouseMoveWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(s.c)({},
                            this.defaultOptions), t instanceof HTMLElement || "string" == typeof t ? Object(s.c)(this.options, {
                            el: t
                        }) : Object(s.c)(this.options, t), this.el = this.options.el, null == this.el) n('Instance needs "el" param!');
                    else if (! (this.options.el instanceof HTMLElement || (h = this.el, this.el = Object(s.e)(h), this.el))) return void n("Cannot find element", h);
                    for (r = 0; r < this.el.children.length; r++) e = this.el.children[r],
                ...
                animationLoop() {
                    ...
                    this.uniforms && (this.uniforms.u_time.value = .016667 * this.t2),
                        t = this.el.offsetHeight,
                        e = this.el.getBoundingClientRect(),
                        h = null != (r = window.pageYOffset) ? r: (document.documentElement || document.body.parentNode || document.body).scrollTop,
                        s = (o = e.top + h) - window.innerHeight,
                        i = o + t,
                    this.options.mouseEase && (this.mouseEaseX = this.mouseEaseX || this.mouseX || 0, this.mouseEaseY = this.mouseEaseY || this.mouseY || 0, Math.abs(this.mouseEaseX - this.mouseX) + Math.abs(this.mouseEaseY - this.mouseY) > .1 && (this.mouseEaseX = this.mouseEaseX + .05 * (this.mouseX - this.mouseEaseX), this.mouseEaseY = this.mouseEaseY + .05 * (this.mouseY - this.mouseEaseY), this.triggerMouseMove(this.mouseEaseX, this.mouseEaseY))),
                    s <= h && h <= i && ("function" == typeof this.onUpdate && this.onUpdate(), this.scene && this.camera && (this.renderer.render(this.scene, this.camera), "transparent" == this.options.backgroundColor ? this.renderer.setClearColor(this.options.backgroundColor, 0) : this.renderer.setClearColor(this.options.backgroundColor, this.options.backgroundAlpha)), this.fps && this.fps.update && this.fps.update()),
                ...
                destroy() {
                    ...
                    this.renderer && (this.el.removeChild(this.renderer.domElement), this.renderer = null, this.scene = null)
                }
            },
                e.b = o.VantaBase
        },
            ...
            class n extends s.b {
                ...
                genPoint(t, e, i) {
                    ...
                    if (this.points || (this.points = []), this.options.showDots) {
                        const t = new THREE.SphereGeometry(.25, 12, 12),
                ...
                onInit() {
                    ...
                    for (let i = 0; i <= t; i++) for (let s = 0; s <= t; s++) {
                        const n = Object(o.f)( - 3, 3),
                            r = (i - t / 2) * e + Object(o.f)( - 5, 5);
                        let h = (s - t / 2) * e + Object(o.f)( - 5, 5);
                        i % 2 && (h += .5 * e),
                            this.genPoint(r, n - Object(o.f)(5, 15), h),
                            this.genPoint(r + Object(o.f)( - 5, 5), n + Object(o.f)(5, 15), h + Object(o.f)( - 5, 5))
                    }
                ...
                onUpdate() {
                    ...
                    const e = this.camera;
                    Math.abs(e.tx - e.position.x) > .01 && (t = e.tx - e.position.x, e.position.x += .02 * t),
                    Math.abs(e.ty - e.position.y) > .01 && (t = e.ty - e.position.y, e.position.y += .02 * t),
                    ...
                    for (let t = 0; t < this.points.length; t++) {
                        ...
                        const e = this.points[t],
                            c = (this.rayCaster ? this.rayCaster.ray.distanceToPoint(e.position) : 1e3).clamp(5, 15);
                        if (e.scale.x = e.scale.y = e.scale.z = (.25 * (15 - c)).clamp(1, 100), 0 !== e.r) {
                            let t = Math.atan2(e.position.z, e.position.x);
                            a = Math.sqrt(e.position.z * e.position.z + e.position.x * e.position.x),
                                t += 25e-5 * e.r,
                                e.position.x = a * Math.cos(t),
                                e.position.z = a * Math.sin(t)
                        }
                        for (let c = t; c < this.points.length; c++) {
                            const t = this.points[c],
                                u = e.position.x - t.position.x,
                                p = e.position.y - t.position.y,
                                d = e.position.z - t.position.z;
                            if ((a = Math.sqrt(u * u + p * p + d * d)) < this.options.maxDistance) {
                                var l;
                                const c = (2 * (1 - a / this.options.maxDistance)).clamp(0, 1);
                                l = "additive" === this.blending ? new THREE.Color(0).lerp(h, c) : n.clone().lerp(r, c),
                                    this.linePositions[i++] = e.position.x,
