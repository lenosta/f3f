...
!function (e) {
    ...
    function i(e, t) {
        ...
        l = function l(e) {
            ...
            var n = u(e),
                ...
                o = i ? { r: parseInt(i[1], 16), g: parseInt(i[2], 16), b: parseInt(i[3], 16) } : null;return "rgba(" + o.r + "," + o.g + "," + o.b + "," + t + ")";
        };
}, function (e, t, n) {
    "use strict";
    n.d(t, "a", function () {
        return o;
    });var i = n(0);window && !window.VANTA && (window.VANTA = { version: "0.3.1" });var o = window.VANTA || {};o.register || (o.register = function (e, t) {
        o[e] = function (e) {
            return new t(e);
        };
    });var s = function s() {
    ...
    var s = function (_i$b) {
        ...
        function s(e) {
            ...
            (_this = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, e)), _this), _this.mode = "shader", _this.updateUniforms = _this.updateUniforms.bind(_this);return _this;
        }
        ...
        _createClass(s, [{
            ...
            value: function initBasicShader() {
                ...
                var n, i, o;return t || (t = "uniform float u_time;\nuniform vec2 u_resolution;\nvoid main() {\n  gl_Position = vec4( position, 1.0 );\n}"), this.updateUniforms(), "function" == typeof this.valuesChanger && this.valuesChanger(), n = new THREE.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t, fragmentShader: e }), (o = this.options.texturePath) && (this.uniforms.u_tex = { type: "t", value: new THREE.TextureLoader().load(o) }), i = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), n), this.scene.add(i), this.camera = new THREE.Camera(), this.camera.position.z = 1;
            }
        }, {
            key: "updateUniforms",
            value: function updateUniforms() {
                var e, t, n, i;for (e in t = {}, n = this.options) {
                    i = n[e], -1 !== e.toLowerCase().indexOf("color") ? t[e] = { type: "v3", value: new THREE.Color(i).toVector() } : "number" == typeof i && (t[e] = { type: "f", value: i });
                }return Object(o.c)(this.uniforms, t);
            }
        }, {
            key: "init",
            value: function init() {
                _get(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "init", this).call(this), this.fragmentShader && this.initBasicShader();
            }
        }, {
            key: "resize",
            value: function resize() {
                _get(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "resize", this).call(this), this.uniforms.u_resolution.value.x = this.width / this.scale, this.uniforms.u_resolution.value.y = this.height / this.scale;
            }
        }]);
